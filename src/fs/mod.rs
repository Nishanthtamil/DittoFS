...
impl PathFilesystem for DittoFS {
                ...
                if let Some(ValueOrContainer::Container(Container::Map(m))) = metadata.get(&child_id.to_string()) {
                    if let Some(ValueOrContainer::Value(loro::LoroValue::String(n))) = m.get("name") {
                        if n.as_ref() == name.to_string_lossy() {
                            let is_dir = if let Some(ValueOrContainer::Value(loro::LoroValue::String(t))) = m.get("type") {
                                t.as_ref() == "directory"
                            } else {
                                false
                            };
    ...
    async fn setattr(
        ...
        let is_dir = if let Some(ValueOrContainer::Value(loro::LoroValue::String(t))) = meta_map.get("type") {
            t.as_ref() == "directory"
        } else { false };
        let mode_val = if let Some(ValueOrContainer::Value(loro::LoroValue::I64(v))) = meta_map.get("mode") { v as u16 } else { 0o755 };
        let size_val = if let Some(ValueOrContainer::Value(loro::LoroValue::I64(s))) = meta_map.get("size") { s as u64 } else { 0 };
    ...
    async fn getattr(
        ...
        if let Some(id) = node_id {
            if let Some(ValueOrContainer::Container(Container::Map(m))) = metadata.get(&id.to_string()) {
                is_dir = if let Some(ValueOrContainer::Value(loro::LoroValue::String(t))) = m.get("type") {
                    t.as_ref() == "directory"
                } else {
                    false
                };
                ...
                size = if let Some(ValueOrContainer::Value(loro::LoroValue::I64(s))) = m.get("size") { s as u64 } else { if is_dir { 4096 } else { 0 } };
                ...
                if current_offset > offset {
                    if let Some(ValueOrContainer::Container(Container::Map(m))) = metadata.get(&child_id.to_string()) {
                        if let Some(ValueOrContainer::Value(loro::LoroValue::String(n))) = m.get("name") {
                            ...
                            let size = if let Some(ValueOrContainer::Value(loro::LoroValue::I64(s))) = m.get("size") { s as u64 } else { if is_dir { 4096 } else { 0 } };
