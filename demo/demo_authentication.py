...
async def demo_account_lockout():
    ...
    with tempfile.TemporaryDirectory() as temp_dir:
        ...
        try:
            ...
            wrong_credentials = UserCredentials(username=username, password="WrongPassword")
    ...
    with tempfile.TemporaryDirectory() as temp_dir:
        ...
        try:
            ...
            try:
                ...
                print(f"  QR Code URL: otpauth://totp/DittoFS:{username}?secret={secret}&issuer=DittoFS")
    ...
    with tempfile.TemporaryDirectory() as temp_dir:
        ...
        try:
            ...
            user = await auth_service.create_user(
                username, password,
                auth_methods=[AuthMethod.KEY_FILE]
            )
            ...
            bad_credentials = UserCredentials(
                username=username,
                key_file_path=Path("/nonexistent/key/file")
            )
