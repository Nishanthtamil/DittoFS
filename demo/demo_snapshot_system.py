...
def create_demo_files(demo_dir: pathlib.Path):
    ...
    files = {
        ...
        "config.json": json.dumps({"setting1": "value1", "setting2": 42, "enabled": True}, indent=2),
...
def demo_basic_snapshots():
    ...
    with tempfile.TemporaryDirectory() as temp_dir:
        ...
        from src.dittofs.snapshot_system import SnapshotSystem, SnapshotType, RestoreOptions, RestoreScope
...
def demo_snapshot_policies():
    ...
    with tempfile.TemporaryDirectory() as temp_dir:
        ...
        from src.dittofs.snapshot_system import SnapshotSystem, SnapshotPolicy, SnapshotType
...
def demo_advanced_features():
    ...
    with tempfile.TemporaryDirectory() as temp_dir:
        ...
        from src.dittofs.snapshot_system import (
            SnapshotSystem, SnapshotType, RestoreOptions, RestoreScope
        )
        from src.dittofs.crdt_store import CRDTStore
        from src.dittofs.chunker import split
