...
class MockConnection:
    ...
    def __init__(self, peer_id: str, network_conditions: Optional[NetworkCondition] = None):
...
class MockCRDTStore:
    ...
    def merge_with(self, other_store: 'MockCRDTStore'):
        ...
        for file_key, file_data in other_store.files.items():
            if file_key not in self.files or file_data["version"] > self.files[file_key]["version"]:
