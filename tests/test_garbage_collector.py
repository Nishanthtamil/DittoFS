...
from src.dittofs.garbage_collector import (
    GarbageCollector, ChunkReferenceTracker, RetentionPolicy, GCStats,
    get_garbage_collector, run_garbage_collection
)
...
class TestChunkReferenceTracker:
    ...
    def test_get_orphaned_chunks(self, mock_chunk_dir, tracker, mock_store):
        ...
        mock_chunk_dir.iterdir.return_value = [
            chunk1_mock, chunk2_mock, chunk3_mock, not_chunk_mock
        ]
...
class TestGarbageCollector:
    ...
    def test_stats_persistence(self, gc, tmp_path):
        ...
        with patch.object(gc, 'get_stats_file_path', return_value=tmp_path / 'gc_stats.json'):
            # Add some stats
